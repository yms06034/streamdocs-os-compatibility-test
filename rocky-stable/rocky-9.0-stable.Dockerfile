...
ENV RL_VER=9.0 \
    ...
    RL_BASEOS=http://dl.rockylinux.org/vault/rocky/9.0/BaseOS/x86_64/os/ \
    RL_APPSTR=http://dl.rockylinux.org/vault/rocky/9.0/AppStream/x86_64/os/ \
    RL_CRB=http://dl.rockylinux.org/vault/rocky/9.0/CRB/x86_64/os/ \
    RL_EXTRAS=http://dl.rockylinux.org/vault/rocky/9.0/extras/x86_64/os/
